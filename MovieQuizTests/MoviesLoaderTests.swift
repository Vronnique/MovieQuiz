...
class MoviesLoaderTests: XCTestCase {
    func testSuccessLoading() throws {
        ...
        // when
        let expectation = expectation(description: "Loading ecpectation") // тк функция загрузки - асинхронная
        ...
        loader.loadMovies { result in
            ...
            case .failure(_):
                XCTFail("Unexpected failure") // функция проваливает тест в случае ошибки
            }
        }
